...
int index_save(const Index *index) {
    ...
    // Fix: Cast away const to sort in place, or sort a copy of the pointers.
    // For a lab, sorting the actual index in-memory is the simplest fix.
